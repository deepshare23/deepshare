...
# DLCM: Add transformer-xl modules to system path
sys.path.append(os.path.join(os.environ['DLCM_PATH'], 'models/transformer-xl/pytorch'))
sys.path.append(os.path.join(os.environ['DLCM_PATH'], 'models/transformer-xl/pytorch/util'))
...
def run(slurm_handler: DLCMSlurmHandler):
    ...
    # TODO: DLCM checkpointer restart entry for model states
    if args.restart:
        # Model load
    ...
    # TODO: DLCM checkpointer restart entry for optimizer states
    if args.restart:
...
if __name__ == '__main__':
    ...
    slurm_handler = DLCMSlurmHandler(DummyDLCMJobCheckpointer()) # TODO: add checkpointer
