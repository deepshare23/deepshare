...
from utils.timm_checkpoint import TIMMDLCMJobCheckpointer
...
def main(slurm_handler: DLCMSlurmHandler):
...
def train_one_epoch(
        ...
        loss_scaler=None, model_ema=None, mixup_fn=None, slurm_handler: DLCMSlurmHandler = None):
...
if __name__ == '__main__':
    ...
    slurm_handler = DLCMSlurmHandler(TIMMDLCMJobCheckpointer(args.resume, args.hdfs_ckpt_dir))
