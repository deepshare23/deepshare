...
"""Defines handler class that all DLCM jobs to have to be run in slurm backend."""
...
class DLCMSlurmHandler:
    def __init__(self, checkpointer: DLCMJobCheckpointer):
    ...
    def load_dlcm_job(self, *args, **kwargs):
    ...
    def bypass(self, signum=0, frame=0):
        print(f"[DLCMSlurmHandler] bypass -- signal{signum} received")


    def preempt(self, signum=0, frame=0):
        print(f"[DLCMSlurmHandler] preempt -- signal{signum} received")
        print("[DLCMSlurmHandler] Requesting checkpoint")
    ...
    def save_checkpoint(self):
        ...
        # print("[DLCMSlurmHandler] Requesting requeue")
    ...
    def install_profiler(self, profile_path: str = './', profile_gpu = True, profile_cpu = True, profile_progress = True, profile_iteration = 1):
        ...
        self.profiler = DLCMProfiler(profile_path=profile_path, profile_iteration=profile_iteration)
